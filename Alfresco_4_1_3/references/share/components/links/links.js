...
(function()
{
    ...
    * @constructor
    */
   Alfresco.Links = function(htmlId, linksDeleteName)
   {
      ...
      this.linksDeleteName = linksDeleteName; 
            ...
            if (this.checkPermissionSelectedLinks(arr))
            {
               if (Dom.getElementsByClassName("delete-item", "a")[0] == null)
               {
                  if (menu.getItems().length == 0)
                  {
                     ...
                     tagLi.innerHTML = "<a class='delete-item' rel='' href='#'><span class='links-action-delete'>" + this.linksDeleteName + "</span></a>";
