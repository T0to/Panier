...
--ASSIGN:alf_node_assoc_max_id=next_val
SELECT CASE WHEN MAX(id) IS NOT NULL THEN MAX(id)+1 ELSE 1 END AS next_val FROM t_alf_node_assoc; 

-- So now it's just raw data
-- Reconstruct the table
CREATE TABLE alf_node_assoc
(
    id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH ${alf_node_assoc_max_id}),
