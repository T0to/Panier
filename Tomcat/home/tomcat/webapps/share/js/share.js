...
(function()
{
   ...
   YAHOO.extend(Alfresco.component.SimpleDocList, Alfresco.component.Base,
   {
      ...
      /**
       * Add smile, externalize the built of the datatable in order to customize it
       */
      getDataTable: function SimpleDocList_getDataTable(){
    	  return new Alfresco.util.DataTable(
    		         {
    		            dataSource:
    		            {
