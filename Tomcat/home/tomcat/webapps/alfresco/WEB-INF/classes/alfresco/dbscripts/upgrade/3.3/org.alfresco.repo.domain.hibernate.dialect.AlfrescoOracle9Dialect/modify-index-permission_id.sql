...
ALTER TABLE alf_access_control_entry DROP UNIQUE (permission_id, authority_id, allowed, applies, context_id);  -- (optional)
ALTER TABLE alf_access_control_entry DROP UNIQUE (permission_id, authority_id, allowed, applies);              -- (optional)
